...
class AdditionalPickupActivity : BaseActivity(), View.OnClickListener {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_additional_pickup)
        //Onclick Event
    ...
    override fun onClick(v: View?) {
        when(v)
        {
            ...
            {
                SubmitFragment.show(this@AdditionalPickupActivity)
            }
        }
    }
}
