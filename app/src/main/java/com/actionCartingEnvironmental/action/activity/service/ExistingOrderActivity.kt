...
import kotlinx.android.synthetic.main.activity_existing_order.*
import kotlinx.android.synthetic.main.dialog_submit.*
import kotlinx.android.synthetic.main.dialog_winter_schedule.*
import kotlinx.android.synthetic.main.view_title.*

class ExistingOrderActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when(v)
        {
            ...
            {
                SubmitFragment.show(this@ExistingOrderActivity)
            }
        }
    }
}
